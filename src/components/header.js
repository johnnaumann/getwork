    ...
    <header class="fixed top-0 left-0 right-0 flex justify-center items-center w-full md:p-[35px] p-[20px] z-10 overflow-hidden transition-colors group hover:bg-background">
      <div class="flex justify-between items-center w-full max-w-[1240px] flex-nowrap">
        ...
        <div class="flex items-center flex-nowrap">
          <nav class="hidden lg:flex text-white text-[15px] tracking-[-0.3px] transition-colors group-hover:text-black flex-nowrap items-center whitespace-nowrap gap-[clamp(16px,2.5vw,34px)]">
            <a href="#features" class="transition-colors">Home</a>
            <a href="#social-proof" class="transition-colors">Services</a>
            <a href="#pricing" class="transition-colors">Why us?</a>
            <a href="#pricing" class="transition-colors">Reviews</a>
            <a href="#pricing" class="transition-colors">Recent work</a>
