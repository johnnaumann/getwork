...
export function renderHero() {
  return `
    <section id="home" class="h-[570px] md:h-[713px] lg:h-[720px] w-full relative overflow-hidden">
      <div class="absolute top-0 left-0 w-full h-[570px] md:h-[713px] lg:h-[720px] md:px-[35px] px-[20px]">
        <div class="mx-auto flex h-[570px] md:h-[713px] lg:h-[720px] w-[1240px] relative">
