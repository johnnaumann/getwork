  ...
  return `
    <section id="hero" class="h-[740px] w-full relative overflow-x-hidden">
      ...
      <div class="absolute top-0 left-0 w-full h-[740px] px-[35px]">
        <div class="mx-auto flex h-[740px] w-[1220px] relative">
          <div class="mt-[200px]">
            <h2 class="text-white text-[40px] leading-[48px] font-bold">Certified and trusted roofing<br>specialists in Glasgow</h2>
            <ul class="text-[#D2D2D2] text-[18px] font-medium mt-[30px] font-title">
              <li class="flex items-center">
                <img src="/img/list.png" class="w-[24px] h-[24px] inline-block mr-[10px]"> NFRC &amp; Trustmark Certified
              </li>
            </ul>
          </div>
